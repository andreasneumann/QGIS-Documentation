...
.. note:: **Use of Virtual Fields**
   ...
   * Virtual fields are marked with a purple background to distinguish them
     from regular or joined fields. Their expression can be edited later by
     by pressing the expression button in the Comment column. An expression
     editor window will be opened to adjust the expression of the virtual field.
